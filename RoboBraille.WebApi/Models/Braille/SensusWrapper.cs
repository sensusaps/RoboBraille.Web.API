...
namespace RoboBraille.WebApi.Models
{
    internal class SensusWrapper
    {
        ...
        public SensusWrapper(BrailleLanguage language, BrailleContraction contractionLevel, BrailleFormat dots)
        {
        ...
        private IContractor InitContractionResources(BrailleLanguage language, BrailleContraction contractionLevel, BrailleFormat dots)
        {

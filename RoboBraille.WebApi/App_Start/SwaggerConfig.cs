...
namespace RoboBraille.WebApi
{
    ...
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.RootUrl(req => req.RequestUri.GetLeftPart(UriPartial.Authority) + System.Web.VirtualPathUtility.ToAbsolute("~/").TrimEnd('/'));
        ...
        {
            return System.String.Format(@"{0}\bin\RoboBraille.WebApi.XML", System.AppDomain.CurrentDomain.BaseDirectory);
        }
    }
}
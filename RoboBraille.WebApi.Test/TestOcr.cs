...
namespace RoboBraille.WebApi.Test
{
    ...
    {
        [TestMethod]
        public async Task TestOcrConversion()
        {
            //init
            ...
            OcrConversionJob ocrj = new OcrConversionJob()
            {
                Id = Guid.NewGuid(),
            ...
            OcrConversionJob ocrj2 = new OcrConversionJob()
            {
                Id = Guid.NewGuid(),
            ...
            var jobs = new List<OcrConversionJob> { ocrj2 }.AsQueryable();
            ...
            var repo = new OcrConversionRepository(mockContext.Object);
            ...
            var serviceController = new OcrConversionController(repo);
            serviceController.Request = request;
            //call
            await serviceController.Post(ocrj);
            //test

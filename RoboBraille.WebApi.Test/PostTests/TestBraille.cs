    ...
    public class TestBraille
    {
        ...
        public async Task TestPostSensusBraille()
        {
            ...
            BrailleJob brj = new BrailleJob()
            {
                ...
                BrailleLanguage = Language.daDK,
                BrailleFormat = BrailleFormat.eightdot,
                CharactersPerLine = 20,
                LinesPerPage = 20,
                Contraction = BrailleContraction.grade2,
            ...
            var jobs = new List<BrailleJob> { brj2 }.AsQueryable();
            ...
            var repo = new BrailleJobRepository(mockContext.Object);
        ...
        //[TestMethod]
        //public async Task TestPostLibLouisBraille()
        //{ 
        //}
    }
}
